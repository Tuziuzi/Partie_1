...
B.append('<div class="karte warn"><h2>Hochenergie — zwei Regeln, eine Entscheidung</h2>'
 '<p>Der <code>shipyard-designer</code> ist auf <b>v5.22-HE</b> gepatcht und trennt sauber:</p>'
 ...
 '</table></div>'
 '<p>SKILL.md Schritt 4: <i>«Never present the calculator\'s ×3 as "the high-energy penalty" — it is '
 'a payload guard coupled to np, nothing more.»</i> Alle drei Schiffe liegen mit 3,60 / 11,00 / '
 '17,70&nbsp;kW <b>weit unter der Schwelle</b> — die Spielregel greift nicht, also <b>kein Δv ÷ 3</b>.</p>'
 '<h3>Hausentscheidung HE-30 des Tisches</h3>'
 '<p><b>Unterhalb 50&nbsp;kW darf der günstigste Zustand gewählt werden.</b> Das ist immer '
 '<b>(c)</b>, der flache Basiswert, denn cm ist stets ≤ cm×3 und ≤ cm×np. '
 '<b>Zustand (b) <code>ctxNoHE</code> ist ausschliesslich Schiffen vorbehalten, die später erst '
 'gebaut werden und nur als Tochterschiffe dienen</b> — keines der drei fällt darunter.</p>'
 '<div class="wrap"><table>'
 '<tr><th>Schiff</th><th class="n">kW</th><th class="n">np</th><th class="n">(a) ×3</th>'
 '<th class="n">(b) ctxNoHE</th><th class="n">(c) flach [S]</th><th>gewählt</th>'
 '<th class="n">Nutzlast</th></tr>'
 '<tr><td>Feldzeichen</td><td class="n">3,60</td><td class="n">5</td><td class="n">15</td>'
 '<td class="n">25</td><td class="n fett">5</td><td class="ok">(c)</td>'
 '<td class="n">50 → 250 kg</td></tr>'
 '<tr><td>Himmelsauge</td><td class="n">11,00</td><td class="n">2</td><td class="n">6</td>'
 '<td class="n">4</td><td class="n fett">2</td><td class="ok">(c)</td>'
 '<td class="n">1 000 → 2 000 kg</td></tr>'
 '<tr><td>Himmelsbrücke</td><td class="n">17,70</td><td class="n">6</td><td class="n">18</td>'
 '<td class="n">36</td><td class="n fett">6</td><td class="ok">(c)</td>'
 '<td class="n">150 → 900 kg</td></tr></table></div>'
 '<p class="q">Die Differenz zur Spielregel bleibt eine Setzung <b>[S]</b> und ist so im Zustand '
 'geführt. <b>Alle Startmassen unverändert</b> (2,0 / 3,6 / 5,0&nbsp;t) — also kein Werftproblem, '
 'die Auslastung bleibt bei 108,8 von 120,0&nbsp;t (91&nbsp;%), und <b>am Scoring von Zug&nbsp;5 '
 'ändert sich nichts</b>: die fünf Scorer führen unverändert 2,0&nbsp;t und 1,0&nbsp;km/s, '
 'China hält LEO, MEO, HEO, SSO und GEO.</p>'
 '<p class="q">Nebeneffekt der billigsten Wahl: Feldzeichen und Himmelsbrücke brauchen '
 '<b>gar keine Nachteile mehr</b>, der Himmelsauge nur noch drei statt vier.</p></div>')
